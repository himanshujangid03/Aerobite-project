...
function Navbar() {
  return (
    <div className="w-full z-50 flex justify-between px-8 lg:px-12 py-6 sticky top-0 bg-white bg-opacity-50 backdrop-blur-md">
      <a href="/">
        <img
          src={logoTextDark}
          width={207}
          height={40}
          className=" cursor-pointer w-24 h-auto lg:w-[150px]"
          alt="logo"
        />
      </a>

      <div className="hidden text-md lg:flex flex-row gap-24 cursor-pointer w-[60rem] justify-end p-2">
